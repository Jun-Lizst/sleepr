...
#' }
#' @export
download_isruc <- function(target = "./"){# nocov start
...
#' }
#' @export
download_sleepedfx <- function(path = "./"){# nocov start
...
#' }
#' @export
download_dreams_subjects <- function(path = "./"){# nocov start
  if(!dir.exists(path)) dir.create(path)
...
#' @examples
#' \dontrun{
#' download_dreams_spindles()
#' }
#' @export
download_dreams_spindles <- function(path){# nocov start
  if(!dir.exists(path)){
    dir.create(path)
  }
...
#' }
#' @export
download_capslpdb <- function(path = "./"){# nocov start
  if(!dir.exists(path)){
    dir.create(path)
  }
